...
return [
    ...
    'packetsave'      => 'The `-packetsave <filename>` command line option creates a file in your game directory that stores a replay of all your input actions, as well as the random seed used to play. You can use `-packetload <filename>` to load the packetsave, which will automatically play the map exactly like you played it. You can frameskip to speed it up, and use **Alt + T** to take over and continue from any point. This is useful if you make a map and make changes, as it allows you to get back to the point where you fixed a mistake without having the play the entire map from the beginning. You can find more info on the parameters here: <https://keeperfx.net/wiki/command-line-options>',
    'packetload'      => 'The `-packetsave <filename>` command line option creates a file in your game directory that stores a replay of all your input actions, as well as the random seed used to play. You can use `-packetload <filename>` to load the packetsave, which will automatically play the map exactly like you played it. You can frameskip to speed it up, and use **Alt + T** to take over and continue from any point. This is useful if you make a map and make changes, as it allows you to get back to the point where you fixed a mistake without having the play the entire map from the beginning. You can find more info on the parameters here: <https://keeperfx.net/wiki/command-line-options>',
    'packets'         => 'The `-packetsave <filename>` command line option creates a file in your game directory that stores a replay of all your input actions, as well as the random seed used to play. You can use `-packetload <filename>` to load the packetsave, which will automatically play the map exactly like you played it. You can frameskip to speed it up, and use **Alt + T** to take over and continue from any point. This is useful if you make a map and make changes, as it allows you to get back to the point where you fixed a mistake without having the play the entire map from the beginning. You can find more info on the parameters here: <https://keeperfx.net/wiki/command-line-options>',
    'diff'            => 'https://keeperfx.net/workshop/tools/kfx-cfg-diff',
    'cfgdiff'         => 'https://keeperfx.net/workshop/tools/kfx-cfg-diff',
